...
PageJs.prototype = Object.extend(new BPCPageJs(), {
	...
	,_initFormValdation: function(btn, type) {
        ...
        .on('success.form.fv', function(e) {
        	...
        	tmp.data = {};
        	tmp.data.type = type;
        	$(tmp.me._confirm_form_id).getElementsBySelector('[report_date]').each(function(item){
    			tmp.me._signRandID(item);
    			tmp.data[item.readAttribute('report_date')] = jQuery('#' + item.id).data('DateTimePicker').date().utc().format();
    		});
