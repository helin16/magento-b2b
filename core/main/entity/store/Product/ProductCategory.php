...
class ProductCategory extends BaseEntityAbstract
{
	...
	public function getJson($extra = '', $reset = false)
	{
		...
		if(!$this->isJsonLoaded($reset))
		{
			...
			$array['noOfChildren'] = FactoryAbastract::dao(get_class($this))->countByCriteria('parentId = ?', array($this->getId()));
			$array['noOfProducts'] = FactoryAbastract::dao('Product_Category')->countByCriteria('categoryId = ?', array($this->getId()));
		}
