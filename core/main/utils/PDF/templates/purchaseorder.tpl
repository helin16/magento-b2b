                ...
                <div>
                    ...
                    <span class="inlineblock info">
                        ...
                        <span class="inlineblock dates">
                            ...
                            <div class="dateRow"><span class="rowTitle inlineblock">Supplier: </span><span class="rowContent inlineblock">{Supplier}</span></div>
                            <div class="dateRow"><span class="rowTitle inlineblock">Supplier Ref.: </span><span class="rowContent inlineblock">{SupplierRef}</span></div>
                            <div class="dateRow"><span class="rowTitle inlineblock">Total Prodcuts: </span><span class="rowContent inlineblock">{TotalProductCount}</span></div>
                        </span>
                    </span>
                </div>
                <div class="sep">
