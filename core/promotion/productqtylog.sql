...
ALTER TABLE `productqtylog` CHANGE `totalOnHandValue` `totalOnHandValue` DOUBLE(10,4) NOT NULL DEFAULT '0.0000';
ALTER TABLE `productqtylog` CHANGE `totalOnHandValueVar` `totalOnHandValueVar` DOUBLE(10,4) NOT NULL DEFAULT '0.0000';
ALTER TABLE `productqtylog` CHANGE `totalInPartsValue` `totalInPartsValue` DOUBLE(10,4) NOT NULL DEFAULT '0.0000';
ALTER TABLE `productqtylog` CHANGE `totalInPartsValueVar` `totalInPartsValueVar` DOUBLE(10,4) NOT NULL DEFAULT '0.0000';
