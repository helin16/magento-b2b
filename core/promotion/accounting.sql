...
# NEW 2 JAN 2015
ALTER TABLE `productqtylog` ADD `totalInPartsValue` DOUBLE(10,4) NOT NULL DEFAULT '0' AFTER `totalOnHandValue`;
ALTER TABLE `productqtylog` ADD `stockInParts` INT(10) NOT NULL DEFAULT '0' AFTER `stockOnPO`;
ALTER TABLE `productqtylog` ADD `stockInRMA` INT(10) NOT NULL DEFAULT '0' AFTER `stockInParts`;
